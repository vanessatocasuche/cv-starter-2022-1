...
const logoLinkedin = require('./../icons/linkedin-brands.svg');
const logoGithub = require('./../icons/github-brands.svg');
const logoAT = require('./../icons/at-solid.svg');

const Index = () => (
  <main className='mt-8 mr-8 mb-8 ml-8'>
    <div className='flex flex-col'>
      <span className='text-4xl font-semibold text-gray-800 text-center mb-10'>Vanessa Tocasuche Ochoa</span>
