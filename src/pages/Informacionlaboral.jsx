    ...
    <div className='flex flex-wrap text-gray-800 justify-center'>
      <div className='flex flex-col w-96 text-sm px-4 pb-6'>
        ...
        <div className='mb-1 h-auto bg-gray-200 py-4 px-3'>
          ...
          <ul className='list-disc ml-5'>
            ...
            <li>
              Modelado de Base de datos relacional para aplicación según
              requerimientos
            </li>
            <li>
              Maquetación (wireframe y vistas profesionales) en Figma según
              diagramas de flujo
            </li>
            <li>
              Desarrollo front-end de aplicación en Bootstrap, en React.js con
              tailwindCSS.
            </li>
            <li>
              Citar y hacer parte de Reuniones SCRUM con el equipo de trabajo.
            </li>
            <li>
              Presentación semanal y mensual de informes estadisticos en
              DataStudio de la universidad.
            </li>
            ...
            <li>
              Hacer parte de un proyecto de desarrollo desde la primera parte de
              levantar historias de usuario hasta su desarrollo
            </li>
          </ul>
        </div>
      ...
      <div className='flex flex-col w-80 text-sm px-4 pb-6'>
        ...
        <div className='mb-1 h-auto bg-gray-200 py-4 px-3 '>
          ...
          <ul className='list-disc ml-5'>
            <li>
              Diseño y actualización de bases de datos de equipos de redes que
              se encontraban en un proyecto de migración o actualización.
            </li>
            <li>
              Programar solicitudes necesarias para hacer la migración de las
              líneas en los equipos de red
            </li>
          </ul>
        </div>
        <div className=' bg-gray-200 py-1 px-4 rounded-b-lg text-gray-800/30'>
